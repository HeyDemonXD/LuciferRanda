...
bot = telebot.TeleBot('7481961917:AAEwOlgk4UdfLWKiyFonVzEbsIteg4GUdQ8')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "✅ Usage :- /bgmi <target> <port> <time> @LuciferHu"  # Updated command syntax
    else:
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to Your Home, {user_name}! Feel Free to Explore.Dm: @LuciferHu Join > @LuciferXAndroid
